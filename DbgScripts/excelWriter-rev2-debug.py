...
globRow = 1
##### CHANGE globCol EVERY YEAR. Sunday = -1. #dec 31,2015 is a wednesday, so set to 2
globCol = 0 #dec 31,2015 is a wednesday (so globCol = 2)
currMonthName = ""
currDay = ""
globTithiInfo = ""
globNakInfo = ""
...
def main():
    ...
    wbook.save("excel-2017-Vakyam.xls")
