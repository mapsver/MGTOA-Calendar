...
#set the calendar location to: Chandler(21217), Phoenix(21240)
    locationUrl="http://www.drikpanchang.com/location/panchang-city-finder.html?l=21240"
...
# Get started
    ...
    with open(fname, 'w') as outf:
        # 20/09/2017
        dateObj = datetime.datetime(2015, 1, 18)    # SET Start Date (yyyy, mm, dd)
        ...
        while nextDate != "20/01/2015":                 # SET End Date (dd/mm/yyyy)
            time.sleep(5.0)
            outf.write(nextDate + ', ')
